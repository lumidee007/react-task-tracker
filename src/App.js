...
import { Header, Tasks, AddTask, Footer} from './component'
...
// Add New Task
  ...
  return (
      <div className='container'>
          <Header showTask={showTask} showAdd={showAdd} addTask={addTask} />
            {showAdd && <AddTask addTask={addTask} />}
            {tasks.length > 0 ? 
            <Tasks tasks={tasks} delTask={delTask} toggleReminder={toggleReminder}/> : 
            <h3 style={style}>NO TASK AVAILABLE</h3>}
          <Footer />
      </div>
  );
}
